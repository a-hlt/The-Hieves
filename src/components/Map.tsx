    ...
    mapRef.current.on('load', () => {
        zones.forEach((feature) => {
            ...
            switch(feature.quartier) {
                case 'Zone 1':
                    coordinates = features.features[2].geometry.coordinates;
                    break;
                case 'Zone 2':
                    coordinates = features.features[4].geometry.coordinates;
                    break;
                case 'Zone 3':
                    coordinates = features.features[1].geometry.coordinates;
                    break;
                case 'Zone 4':
                    coordinates = features.features[3].geometry.coordinates;
                    break;
                case 'Zone 5':
